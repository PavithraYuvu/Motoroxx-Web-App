...
export class EstinvComponent implements OnInit {
  ...
  constructor(private LocalStoreService: LocalStoreService, private dialog: MatDialog, private router: Router, private toastr: ToastrService,private ngbModel: NgbModal) {
  ...
  loadtechniciandata(){
    this.LocalStoreService.GetAllTech().subscribe(data=>{
